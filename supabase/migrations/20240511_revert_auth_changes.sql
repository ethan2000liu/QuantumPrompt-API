...
DROP CONSTRAINT IF EXISTS fk_selected_key;

-- Drop tables that reference auth.users
DROP TABLE IF EXISTS usage_logs;
DROP TABLE IF EXISTS api_keys;
DROP TABLE IF EXISTS user_settings;

-- Recreate our custom users table
CREATE TABLE users (
...
-- Recreate tables with references to our users table
